...
- Servicios totales, finalizados y no efectivos del día
- % de cumplimiento global (Finalizados / Total)
- Tabla por ciudad con servicios, finalizados, no efectivos y % de cumplimiento con semáforo (verde ≥ 98%, ámbar ≥ 95%, rojo < 95%)
...
- El % de cumplimiento se calcula como servicios con estado `Finalizado` sobre el total; cualquier otro estado (Cancelado, etc.) cuenta como no efectivo y se detalla en el KPI correspondiente.
